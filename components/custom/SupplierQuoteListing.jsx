            ...
            <Tabs className="w-full" defaultValue="table1">
                ...
                <TabsContent value="table1">
                    <Table>
                        ...
                        <TableBody>
                            {quoteData?.length > 0 ? quoteData.map((d) => (
                                <TableRow key={d?.quote_id}>
                                    ...
                                    <TableCell>
                                        <div className="flex items-center justify-center">
                                            <Link href={{ pathname: `quotation/quote-price/${d?.order_id}`, query: { quote_id: d.quote_id } }}>
                ...
                <TabsContent value="table2">
                    <Table>
                        ...
                        <TableBody>
                            {productQuoteData?.length > 0 ? productQuoteData.map((d) => (
                                <TableRow key={d?.quote_id}>
                                    <TableCell>#{d?.quote_id}</TableCell>
                                    ...
                                    <TableCell>
                                        <div className="flex items-center justify-center">
                                            <Link href={{ pathname: `quotation/quote-price/product/${d?.product_id}`, query: { quote_id: d.quote_id, supplier_id: user.user_id } }}>
                                                <Button>Details</Button>
                                            </Link>
                                        </div>
                                    </TableCell>
